...
namespace UpdateOrederStatus
{
    public static class OrderStatusUpdate
    {
        ...
        public static void Run([ServiceBusTrigger("orderstatus", Connection = "AzureWebJobsServiceBus")]string statusMessage, [SignalR(HubName = "notifications")] IAsyncCollector<SignalRMessage> signalRMessages, ILogger log)
        {
